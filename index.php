...
$index->content .= "<h2 class='py-5 text-white'>Please browse our movie selection<h2>";
    ...
    $index->content .= "<div  class='container d-flex justify-content-center bg-warning text-white rounded'  >";

    //Szűrők
    
    $index->content .= "<div  class='row my-5 d-flex justify-content-center bg-warning text-dark' style='opacity:0.6;'>";
    // Filter by GENRE
