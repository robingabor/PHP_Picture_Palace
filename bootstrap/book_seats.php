...
$bookseats->content .="<div class='screen'></div>"; // SCREEN
    ...
    $bookseats->content .="<h3 class='text'>You have selected: <span id='count' class='text-warning'>0</span> Seats, for a price of $ <span id='total' class='text-warning'>0</span> </h3>";
    ...
    // <!-- Modal content-->
        ...
        // <!-- Ide jön a foglalás dátuma  -->
                    $bookseats->content .="<h4 class='modal-title text-danger'>Your booking details are the following: <span id='title'></span></h4>";        
                    $bookseats->content .="</div>";
                ...
                $bookseats->content .="<label for=''>Date : </label>";
                $bookseats->content .="<input readonly name='date' value=".$_SESSION['booking_movie']['date'].">";
                $bookseats->content .="</div>";                
                $bookseats->content .=" <div class='form-group text-danger'>";
                $bookseats->content .="<label for=''>Movie Title : </label>";                    
                $bookseats->content .="<input readonly name='title' value=".$_SESSION['booking_movie']['title'].">";
                $bookseats->content .="</div>";
                $bookseats->content .="<div class='form-group text-danger'>";
                $bookseats->content .="<label for=''>Selected seats: </label>";                     
                $bookseats->content .="<input type='hidden' readonly name='seats' ><span id='seats'></span></input>";
                $bookseats->content .="</div>";                    
                $bookseats->content .="<div class='form-group text-danger'>";
                $bookseats->content .="<label for=''>Timeslot : </label>";
                $bookseats->content .="<input readonly name='timeslot' value=".$_SESSION['booking_movie']['timeslot'].">";
                $bookseats->content .="</div>";
                $bookseats->content .="<div class='form-group text-danger'>";
                $bookseats->content .="<label for=''>Total price : </label>";
                $bookseats->content .="<input type='hidden' readonly name='price' ><span id='price'></span></input>";
                $bookseats->content .="</div>";
                ...
                $bookseats->content .="<label for=''></label>";
                $bookseats->content .="<input id='confirm' class='btn btn-primary' type='submit' name='submit'>Confirm Booking</input>";
                $bookseats->content .="</div>";
